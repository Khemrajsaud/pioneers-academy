const en = {
  ...
  description:"Established in 1999 AD (2056 BS), Pioneers’ Academy, Kailali is a reputed private educational institution located in Lamkichuha-1, Lamki, Kailali, Sudurpaschim Province, Nepal. The school is affiliated with the National Examination Board (NEB) and approved by the Ministry of Education. Pioneers’ Academy offers comprehensive educational programs from Play Group (PG) to Grade 10, along with Plus Two (Grades 11 and 12) in Management and Law streams.\n\n With a strong commitment to academic excellence, disciplined learning, and holistic development, the academy provides quality education at a moderate fee structure. The institution also offers scholarship opportunities to deserving and talented students, ensuring that education remains accessible to students from diverse backgrounds."
    ...
    commitments: {
      ...
      safety: "Student Safety & Well-being",
  ...
  // Academics Page
  academics: {
    hero: "Academic Programs",
    select: "Select Level",
    primary: {
      title: "Primary School",
      subtitle: "Grades 1-5",
      description:
        "Our Primary School program focuses on building strong foundations in literacy, numeracy, and social skills. Through engaging, play-based learning and structured academics, we nurture curiosity and a love for learning in our youngest students.",
      highlights: "Key Features",
      features: [
        "Child-centered learning approach",
        "Development of basic literacy and numeracy skills",
        "Introduction to arts, music, and physical education",
    ...
    secondary: {
      ...
      description:
        "The Secondary School program challenges students with a comprehensive curriculum that develops critical thinking, analytical skills, and subject mastery. We prepare students for higher academic pursuits while fostering personal growth and social responsibility.",
      highlights: "Key Features",
      features: [
    ...
    senior: {
      ...
      description:
        "Our Senior School program offers specialized streams in Science, Management, and Humanities, preparing students for university education and professional careers. With advanced coursework, examination preparation, and university counseling, we guide students toward their chosen paths.",
      highlights: "Key Features",
      features: [
        "Choice of Science, Management, or Humanities streams",
      ...
      curriculum: "Available Streams",
      subjects: [
        "Science: Physics, Chemistry, Biology/Mathematics",
        "Management: Business Studies, Economics, Accountancy",
        "Humanities: Sociology, Psychology, History",
        "Common: English, Nepali",
        "Electives: Computer Science, Environmental Science",
        "Practical: Lab Work, Projects, Presentations",
      ],
    },
  },
  ...
  facilities: {
    ...
    classroom: {
      ...
      description:
        "Spacious, well-ventilated classrooms equipped with smart boards and digital learning tools",
    },
    science: {
      title: "Science Labs",
      description:
        "Fully equipped Physics, Chemistry, and Biology laboratories for hands-on learning",
    },
    computer: {
      title: "Computer Lab",
      description:
        "Modern computer lab with high-speed internet and latest software",
    },
    library: {
      title: "Library",
      description:
    ...
    sports: {
      ...
      description:
        "Basketball, volleyball courts, and indoor sports facilities",
    },
    auditorium: {
      title: "Auditorium",
      description:
        "State-of-the-art auditorium for events, programs, and presentations",
    },
    cafeteria: {
      title: "Cafeteria",
    ...
    highlights: {
      ...
      wifi: "High-speed WiFi across campus",
      playground: "Spacious playground and green spaces",
      medical: "Medical room with first aid facilities",
      parking: "Secure parking for staff and visitors",
